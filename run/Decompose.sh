...
if [[ -z "$1" ]]; then
    ...
    sudo numactl -N 0 -m 0 -C 2 ./decompose_functions -o Decompose_1 -p 75 -t ddr4 -n 4 -s 32 -r 2 -w 4 -f 0x40,0x100,0x4000,0x80000,0x100000,0x200000,0x1000000000 -R 0xfffc70000 -C 0xbe80 -d -v -l
elif [[ "$1" == "1" ]]; then
